...
import { fetchCategoryInsecticide } from '../../../flux/actions'
...
const InsecticideSlider = (props) => {

   const { insecticide, fetchCategoryInsecticide } = props
    useEffect(() => {
